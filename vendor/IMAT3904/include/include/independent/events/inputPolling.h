...
namespace Engine {
	...
	/**
	\class Bsse class for direct polling of input
	*/

	class InputPoller
	{
	private:
		static InputPoller* s_instance; //!< Single instance pointer - singleton, however only internal implementation
	protected:
		...
		virtual glm::vec2 getMousePositionImpl() = 0; //!< Windows API specific implementation of mous position 
